 ...
 * GET /call-status/me
 */
export const getMyCallStatus = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user!.id;
 ...
 */
export const getPartnerCallStatus = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user!.id;
 ...
 * DELETE /call-status
 */
export const clearCallStatus = async (req: Request, res: Response): Promise<void> => {
  try {
    const userId = req.user!.id;
